    ...
    <div class="paper">
        <div class="papercenter">
                    ...
                    <div class="tabbable commitleft pull-left">
                        <ul id="w0" class="nav nav-tabs copyload"><li class="active"><a href="/panel/account/index">基本信息</a></li>
            <li><a href="/panel/account/purchase">充值记录</a></li>
            <li><a href="/panel/account/change-password">修改密码</a></li>
            <li><a href="/panel/account/weixin">微信绑定</a></li></ul>            <div class="tab-content">
                            <ul class="tab-pane personinforlist active" id="personinfor">
                                <li class="pername"></li>
                                <li class="perinfor">
                                    <span class="informark">用户名：</span>
                                    <span class="inforvalue">taisite</span>
                                </li>
                                <li class="perinfor">
                                    <span class="informark">账户类型：</span>
                                    <span class="inforvalue">PaperPass用户</span>
                                </li>
                                                    <li class="perinfor">
                                    <span class="informark">电子邮箱：</span>
                                    <span class="inforvalue">zydaixie@126.com</span>
                                </li>
                                                                        <li class="perinfor">
                                ...
                                <li class="signtime MT20">注册时间： 2019-11-20 9:21:55</li>
                            </ul>
                        </div>
                    </div>
